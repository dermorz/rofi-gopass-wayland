#+title: rofi-gopass-wayland
#+author: earthian
#+email: 418@duck.com
#+startup: content indent

A [[https://github.com/lbonn/rofi][rofi-wayland]] frontend for [[https://github.com/gopasspw/gopass][gopass]]. This is a fork of rofi-pass-wayland adapted to work with gopass.
...
- [[https://fukuchi.org/works/qrencode/][qrencode]] (optional: for generating and displaying gopass qrcode)
